...
- **Feb 6**: ENH-015 (Active Game Screen agenda section collapsible: default collapsed with summary bar showing agenda names + progress total, tap to expand for full cards, animated transitions).
